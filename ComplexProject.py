...
plt.plot(Systems, avg, 'bo', label = 'Measured times')
plt.plot(x, Fit(x,*popt), '-r', label = '$aL^{b}$')
...
plt.plot(Systems, heights, 'bo', label = 'Measured heights')
plt.plot(x, Lin(x,*poptl), '--k', label = 'Single term function fit')
plt.plot(x, Corr(x,*popt), '-r', label = 'Two term function fit')
plt.plot
...
plt.plot(Systems, stdevs, 'bo', label = 'Measured deviations')
plt.plot(Systems, Fit(Systems, *popt), '-r', label = '$mL^{b}$')
plt.xscale('log')
plt.yscale('log')
plt.xlabel('$L$', fontsize = 15)
...
plt.plot(x4,y4, '-', label='L=4')
plt.plot(x8,y8, '-',label='L=8')
plt.plot(x16,y16, '-', label='L=16')
plt.plot(x32,y32, '-',label='L=32')
plt.plot(x64,y64, '-',label='L=64')
plt.plot(x128,y128, '-',label='L=128')
plt.plot(x256,y256, '-',label='L=256')
plt.xscale('log')
plt.yscale('log')
plt.grid()
...
plt.plot(SL, MAL, 'bo', label = 'Measured data')
plt.plot(x, Dee(x, *popD), '-r', label = 'Fit of a power law')
#plt.yscale('log')
#plt.xscale('log')
plt.grid(which = 'both')
...
print('Tau is ', popT[1], 'pm',  np.sqrt(pcovD[1][1]))
print('a is ', popT[0], 'pm',  np.sqrt(pcovD[0][0]))
plt.plot(x256,y256, 'kx',label='L=256')
plt.plot(x, Tau(x, *popT), '-r', label='Fit of a power law')
plt.xscale('log')
plt.yscale('log')
plt.grid()
plt.legend(fontsize = 15)
...
for i in range(no_moments):
    ...
    print('K={}'.format(i+1) , popt[i], np.sqrt(pcov[i][0]))
...
plt.plot(x,y, 'o', label = 'Calculated slopes')
plt.plot(x,Line(x,*opt), '--', label = 'Linear fit')
plt.grid()
plt.legend(fontsize = 15)
